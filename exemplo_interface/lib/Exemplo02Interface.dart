...
title: Text('Integrantes OLDSCHOOL'),
),
// Corpo da tela, composto por um Column (coluna vertical) dewidgets
body: Column(
children: [
// Texto simples como primeiro filho da colunaText('Primeiro Filho'),
// Container contendo um Row (linha horizontal) de dois Text widgets
Row(
  children: [
    Padding(padding: EdgeInsets.all(16.0)),
    Text('Nome:')
    Text('Enantato de Trembolona')
    ],
)